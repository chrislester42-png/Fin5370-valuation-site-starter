...
You wrote [NUMBER] for [FACT]. Show me exactly where it comes from: the file, the cell or the sentence. If it is not there, remove it and list it under "Numbers we still need."
